  ...
  var SSNValidator = {
    ...
    validate : function(ssnValue) {
      ...
      function validDate(value){
        ...
        return moment(date, "DDMMYY").isValid();
      }

      function validLength(value) {
        return ssnValue.length == 11;
      }

      function validChecksum(ssn){

          if (ssn.length != 11) return false;

            // Split
          var day = ssn.substr(0, 2);
          var month = ssn.substr(2, 2);
          var year = ssn.substr(4, 2);
          var ind = ssn.substr(6, 3);
          var c1 = ssn.substr(9, 1);
          var c2 = ssn.substr(10, 1);
      ...
      if (!checkInteger(ssnValue) ||  !validLength(ssnValue) || !validDate(ssnValue) || !validChecksum(ssnValue)) {
        return false;
      }
